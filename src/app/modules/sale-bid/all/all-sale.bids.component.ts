...
@Component({
  selector: 'app-sale-bids-all',
  templateUrl: './all-sale.bids.component.html',
  styleUrls: ['./all-sale.bids.component.css']
})
export class AllSaleBidsComponent implements OnInit, AfterViewInit {
